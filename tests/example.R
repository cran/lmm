...
# scoring algorithm
#
ecmeml.result <- ecmeml.lmm(y,subj,occ,pred,xcol,zcol)
fastml.result <- fastml.lmm(y,subj,occ,pred,xcol,zcol)
#
...
#
ecmerml.result <- ecmerml.lmm(y,subj,occ,pred,xcol,zcol)
fastrml.result <- fastrml.lmm(y,subj,occ,pred,xcol,zcol)
#
#######################################################################
...
gibbs.result <- mgibbs.lmm(y,subj,occ,pred,xcol,zcol,prior=prior,
   seed=1234,iter=5000)
fmcmc.result <- fastmcmc.lmm(y,subj,occ,pred,xcol,zcol,prior=prior,
   seed=2345,iter=5000)
# 
